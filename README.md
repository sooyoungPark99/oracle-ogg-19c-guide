...
Oracle Linux 7.7 환경에서 GoldenGate 19c를 설치하고 orcl → clonedb 단방향 복제를 구성하는 실습 가이드입니다.
...
|---------|-----------|--------|--------|---------|
| ora19c_single | ora-19c | 4GB | 어댑터에 브리지 | Oracle 19c Single 신규 설치 |
...
| OGG_HOME | `/u01/app/oracle/goldengate/19c` |
...
|----|----|---------|----------|---------|
| ora19c_single | 172.xx.xx.xx | 255.255.0.0 | 172.xx.xx.xx | 8.8.8.8 |
...
- 파일시스템 기반 Single 환경에서 OGG 19c 설치 및 구성
